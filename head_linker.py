...
5) Чтобы уметь эффективно вставлять одну ссылку, нужно отрефакторить add_head_links - словарь заголовков создавать один раз, и уметь вызывать отдельно обработку одного документа
"""
